...
awful.rules.rules = gears.table.join(awful.rules.rules, apps.rules)
...
-- After everything is done, start the widgets
apps.widgets.spawn_spotify()
apps.widgets.spawn_htop()
apps.widgets.spawn_slack()
